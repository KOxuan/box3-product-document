...
/* empty css               */
const __pageData = JSON.parse('{"title":"构造函数","description":"","frontmatter":{},"headers":[],"relativePath":"package/component/api/Component.md","filePath":"package/component/api/Component.md","lastUpdated":1742382052000}');
...
const _sfc_main = /* @__PURE__ */ Object.assign(__default__, {
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(_attrs)}><h1 id="构造函数" tabindex="-1">构造函数 <a class="header-anchor" href="#构造函数" aria-label="Permalink to &quot;构造函数&quot;">​</a></h1><h4 id="Component" tabindex="-1">`);
      ...
      _push(` <a class="header-anchor" href="#Component" aria-label="Permalink to &quot;&lt;font id=&quot;API&quot; /&gt;Component&lt;font id=&quot;Type&quot;&gt;‹T = any›&lt;/font&gt;()&lt;font id=&quot;Type&quot;&gt;: Component&lt;/font&gt;{#Component}&quot;">​</a></h4><p>实例化一个组件类</p><p><strong>返回值</strong></p><table tabindex="0"><thead><tr><th><strong>类型</strong></th><th><strong>说明</strong></th></tr></thead><tbody><tr><td>Component</td><td>组件类</td></tr></tbody></table><h2 id="属性" tabindex="-1">属性 <a class="header-anchor" href="#属性" aria-label="Permalink to &quot;属性&quot;">​</a></h2><h4 id="weight" tabindex="-1">`);
      _push(ssrRenderComponent(_component_font, { id: "API" }, null, _parent));
      _push(`weight`);
      _push(ssrRenderComponent(_component_font, { id: "Type" }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
      ...
      _push(` <a class="header-anchor" href="#update" aria-label="Permalink to &quot;&lt;font id=&quot;API&quot; /&gt;update(&lt;font id=&quot;Type&quot;&gt;deltaTime: number&lt;/font&gt;)&lt;font id=&quot;Type&quot;&gt;: void&lt;/font&gt;{#update}&quot;">​</a></h4><p>如果该组件启用，则每帧（30 FPS）调用 update。</p><p>该方法为生命周期方法，父类未必会有实现。并且你只能在该方法内部调用父类的实现，不可在其它地方直接调用该方法。</p><p><strong>返回值</strong></p><table tabindex="0"><thead><tr><th><strong>类型</strong></th><th><strong>说明</strong></th></tr></thead><tbody><tr><td>deltaTime</td><td>自上次更新以来的时间差，单位为毫秒</td></tr></tbody></table><hr><h4 id="onEnable" tabindex="-1">`);
      _push(ssrRenderComponent(_component_font, { id: "API" }, null, _parent));
      _push(`onEnable()`);
      _push(ssrRenderComponent(_component_font, { id: "Type" }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
