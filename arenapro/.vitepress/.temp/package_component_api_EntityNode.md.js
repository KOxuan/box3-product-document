...
/* empty css               */
const __pageData = JSON.parse('{"title":"构造函数","description":"","frontmatter":{},"headers":[],"relativePath":"package/component/api/EntityNode.md","filePath":"package/component/api/EntityNode.md","lastUpdated":1742559233000}');
...
const _sfc_main = /* @__PURE__ */ Object.assign(__default__, {
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(` <a class="header-anchor" href="#EntityNode" aria-label="Permalink to &quot;&lt;font id=&quot;API&quot; /&gt;EntityNode&lt;font id=&quot;Type&quot;&gt;‹T = any›&lt;/font&gt;(&lt;font id=&quot;Type&quot;&gt;entity:T&lt;/font&gt;)&lt;font id=&quot;Type&quot;&gt;: EntityNode&lt;/font&gt;{#EntityNode}&quot;">​</a></h4><p>实例化一个扩展节点类</p><p>组件只能挂载在扩展节点上。</p><p><strong>输入参数</strong></p><table tabindex="0"><thead><tr><th><strong><em>参数</em></strong></th><th><strong><em>必填</em></strong></th><th><strong><em>默认值</em></strong></th><th><strong><em>类型</em></strong></th><th><strong><em>说明</em></strong></th></tr></thead><tbody><tr><td>entity</td><td>是</td><td></td><td>T</td><td>游戏实体，可以是任意实体，例如角色、道具、ui 等</td></tr></tbody></table><p><strong>返回值</strong></p><table tabindex="0"><thead><tr><th><strong>类型</strong></th><th><strong>说明</strong></th></tr></thead><tbody><tr><td>EntityNode</td><td>扩展节点类</td></tr></tbody></table><h2 id="静态属性" tabindex="-1">静态属性 <a class="header-anchor" href="#静态属性" aria-label="Permalink to &quot;静态属性&quot;">​</a></h2><h4 id="isMonitoringEnabled" tabindex="-1">`);
      _push(ssrRenderComponent(_component_font, { id: "API" }, null, _parent));
      ...
      _push(` <a class="header-anchor" href="#onPerformanceWarning" aria-label="Permalink to &quot;&lt;font id=&quot;API&quot; /&gt;onPerformanceWarning(&lt;font id=&quot;Type&quot;&gt;event: (event: IonPerformanceData) =&gt; void&lt;/font&gt;)&lt;font id=&quot;Type&quot;&gt;: void&lt;/font&gt;{#onPerformanceWarning}&quot;">​</a></h4><p>设置全局组件的性能警告回调。</p><p><strong>输入参数</strong></p><table tabindex="0"><thead><tr><th><strong><em>参数</em></strong></th><th><strong><em>必填</em></strong></th><th><strong><em>默认值</em></strong></th><th><strong><em>类型</em></strong></th><th><strong><em>说明</em></strong></th></tr></thead><tbody><tr><td>event</td><td>是</td><td></td><td>(event: IonPerformanceData) =&gt; void</td><td>回调方法</td></tr></tbody></table><h2 id="方法" tabindex="-1">方法 <a class="header-anchor" href="#方法" aria-label="Permalink to &quot;方法&quot;">​</a></h2><h4 id="addComponent" tabindex="-1">`);
      _push(ssrRenderComponent(_component_font, { id: "API" }, null, _parent));
      _push(`addComponent`);
      _push(ssrRenderComponent(_component_font, { id: "Type" }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
      ...
      _push(ssrRenderComponent(_component_font, { id: "Type" }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`componentConstructor: new (...args: any[]) =&gt; U, object?: Partial‹Omit‹U, keyof Component‹T››› `);
          } else {
            return [
              createTextVNode("componentConstructor: new (...args: any[]) => U, object?: Partial‹Omit‹U, keyof Component‹T››› ")
            ];
          }
        }),
        _: 1
      ...
      _push(` <a class="header-anchor" href="#addComponentName" aria-label="Permalink to &quot;&lt;font id=&quot;API&quot; /&gt;addComponent(&lt;font id=&quot;Type&quot;&gt;componentName: string, object?: Record‹string, any›&lt;/font&gt;)&lt;font id=&quot;Type&quot;&gt;: this&lt;/font&gt;{#addComponentName}&quot;">​</a></h4><p>向该节点增加指定类型的组件。</p><p>子组件类须加上@apclass 修饰器。否则无法获取组件实例。</p><p>【使用组件名】</p><p><strong>输入参数</strong></p><table tabindex="0"><thead><tr><th><strong><em>参数</em></strong></th><th><strong><em>必填</em></strong></th><th><strong><em>默认值</em></strong></th><th><strong><em>类型</em></strong></th><th><strong><em>说明</em></strong></th></tr></thead><tbody><tr><td>componentName</td><td>是</td><td></td><td>string</td><td>组件名</td></tr><tr><td>object</td><td></td><td>{}</td><td>Record&lt;string, any&gt;</td><td>组件初始化属性，默认不修改属性</td></tr></tbody></table><hr><h4 id="getComponentName" tabindex="-1">`);
      _push(ssrRenderComponent(_component_font, { id: "API" }, null, _parent));
      _push(`getComponent(`);
      _push(ssrRenderComponent(_component_font, { id: "Type" }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
