...
#### <font id="API" />copy(<font id="Type">v:GameVector3</font>)<font id="Type">: void</font>{#copy} 
复制三维向量到新的向量上
...
#### <font id="API" />set(<font id="Type">x: number, y: number, z: number</font>)<font id="Type">:  void</font>{#set} 
设置向量值
